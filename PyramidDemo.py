...
#axarr[0, 0].imshow(np.uint8(G[1]),cmap='gray')
#axarr[0, 1].imshow(np.uint8(G[2]),cmap='gray')
#axarr[1, 0].imshow(np.uint8(G[3]),cmap='gray')
#axarr[1, 1].imshow(np.uint8(G[4]),cmap='gray')
#axarr[2, 0].imshow(np.uint8(G[5]),cmap='gray')
#axarr[2, 1].imshow(np.uint8(G[6]),cmap='gray')
#axarr[3, 0].imshow(np.uint8(G[7]),cmap='gray')
#axarr[3, 1].imshow(np.uint8(G[8]),cmap='gray',extent=[0, 1, 0, 1])
#
#axarr[0, 2].imshow(np.uint8(L[1]),cmap='gray')
#axarr[0, 3].imshow(np.uint8(L[2]),cmap='gray')
#axarr[1, 2].imshow(np.uint8(L[3]),cmap='gray')
#axarr[1, 3].imshow(np.uint8(L[4]),cmap='gray')
#axarr[2, 2].imshow(np.uint8(L[5]),cmap='gray')
#axarr[2, 3].imshow(np.uint8(L[6]),cmap='gray')
#axarr[3, 2].imshow(np.uint8(L[7]),cmap='gray')
#axarr[3, 3].imshow(np.uint8(L[8]),cmap='gray')
#
#
#plt.show()
rows, cols = img.shape
